...
import io.github.dianila68.gesturemacro.core.data.MacroIntegrity
...
/**
 * ticket-037: Room-backed macro store quarantined to `.android.data`.
 * Public API is stable — callers importing the old `core.data.MacroStore` typealias continue
 * to work without changes until ticket-038 migrates them to this package directly.
 */
object MacroStore {
